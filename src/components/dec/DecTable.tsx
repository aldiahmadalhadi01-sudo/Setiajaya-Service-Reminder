        ...
        <table className="w-full text-left text-xs border-collapse">
          <thead>
            <tr className="bg-slate-900 text-white font-extrabold uppercase tracking-wider">
              <th className="p-3.5 cursor-pointer hover:bg-slate-800" onClick={() => handleSort('tanggal_dec')}>
              ...
              <th className="p-3.5 cursor-pointer hover:bg-slate-800" onClick={() => handleSort('tipe_kendaraan')}>
          ...
          <tbody className="divide-y divide-slate-200">
            {loading ? (
              ...
              paginatedData.map((row) => (
                <tr key={row.id || row.vin} className="hover:bg-slate-100/80 transition-colors">
                  ...
                  <td className="p-3.5 font-medium text-slate-800">{row.phone_customer}</td>
                  ...
                  <td className="p-3.5 text-slate-800">
                    <span className="px-2 py-0.5 rounded-full bg-slate-100 border border-slate-200 font-bold text-[11px] text-slate-800">
                      {row.payment}
                    </span>
                  </td>
                  <td className="p-3.5 text-slate-800 font-medium">{row.sales}</td>
                  <td className="p-3.5 text-slate-800">{row.kota}</td>
